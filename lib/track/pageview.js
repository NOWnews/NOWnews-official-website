...
export const trackCode = (apiServ, menuId, newsId, pathname, search, headers) => {
  window.ga('set', 'pageview');
  window.ga('26.set', 'pageview');
...
export const init = (apiServ, pathname, search, state, headers) => {
  ...
  trackCode(apiServ, menuId, newsId, pathname, search, headers);
};
